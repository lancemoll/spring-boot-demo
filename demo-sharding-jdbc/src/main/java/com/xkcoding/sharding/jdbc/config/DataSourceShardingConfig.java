...
//        // 设置规则适配的表
    ...
    private TableRuleConfiguration orderTableRule() {
        ...
        tableRule.setActualDataNodes("ds0.t_order_${0..2}");
    ...
    private Map<String, DataSource> dataSourceMap() {
        ...
        ds0.setJdbcUrl("jdbc:mysql://47.108.215.4:3306/spring-boot-demo?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8");
        ds0.setUsername("root");
        ds0.setPassword("lance");

        // 配置第二个数据源
        HikariDataSource ds1 = new HikariDataSource();
        ds1.setDriverClassName("com.mysql.cj.jdbc.Driver");
        ds1.setJdbcUrl("jdbc:mysql://47.108.215.4:3306/spring-boot-demo-2?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8");
        ds1.setUsername("root");
        ds1.setPassword("lance");
